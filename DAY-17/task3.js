...
let titles = books.map((eachBook) => eachBook[1]);
console.log(titles);
...
let classicBooks = books.filter((eachBook) => eachBook[3]=="Classic");
console.log(classicBooks);

console.log("---------------------------------------");

// 	4.	Print books with a rating higher than 4.7.
let higherRatedBooks = books.filter((eachBook) => eachBook[5]>4.7);
console.log(higherRatedBooks);

console.log("---------------------------------------");
// 	5.	Print the details of the book “The Hobbit”.
let hobbitDetails = books.find((eachBook) => eachBook[1]=="The Hobbit");
console.log(hobbitDetails);

console.log("---------------------------------------");
// 	6.	Sort books based on page count in descending order.
let sortedBooksPage = books.toSorted((a,b) => b[4]-a[4]);
console.log(sortedBooksPage);

console.log("---------------------------------------");
// 	7.	Sort books based on ratings in ascending order.
let sortedBooksRating = books.toSorted((a,b) => a[5]-b[5]);
